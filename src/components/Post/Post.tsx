...
const Post = ({name, owner, postedAt, type, className, isHidden, isMobile}: PostPorps) => {
  ...
  return (
    <Link href={'/'} className={`flex flex-col lg:flex-row  ${isHidden ? 'border-gray-1/50 text-gray-2' : 'border-gray-1'} border-b  pt-10 items-start justify-between w-full !${className}`}>
